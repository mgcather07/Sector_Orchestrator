...
| [0007](0007-web-roster-order-and-host-add.md) Web roster order + host add-team | tournament-registration | Web_Sector | web | feature | **approved** (2026-08-24) | Parity with **iOS PR #191** (owner surface). Same two features; same unique-id caveat. |
